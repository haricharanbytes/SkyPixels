...
ndvi = np.empty(red.shape, dtype=rasterio.float32)  # Create empty matrix
...
ndviImage = rasterio.open('ndvi.tif','w',driver = 'GTiff',width=redband.width, height=redband.height, count=1 ,crs=redband.crs ,transform=redband.transform ,dtype='float32')
